...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if ($('.address-slider').length > 0) {
        new Swiper('.address-slider', {
            speed: 500,
            slidesPerView: 1,
            navigation: {
                nextEl: '.address-button-next',
                prevEl: '.address-button-prev',
            },
        })
    }
    ...
    $('[data-pack-expand]').click(function() {
    ...
    window.addEventListener('scroll', function (e) {
        if (window.scrollY > 100) {
            document.querySelector('.train').addEventListener('click', scrollFn, false)
            document.body.classList.add('train-shown')
        } else {
            document.querySelector('.train').removeEventListener('click', scrollFn, false)
            document.body.classList.remove('train-shown')
        }
    })
